...
\newcommand{\titleblock}{%
    ...
    {\fontsize{12}{14}\selectfont\bfseries STATISTICS AND DATA SCIENCE}\\[20pt]
...
\begin{titlepage}
    ...
    \textbf{Tanishtha Poddar (86062400074)}
    under our supervision. We certify that this is her bonafide work.
...
\begin{titlepage}
    ...
    \noindent I would like to express my sincere gratitude to my project
    ...
    course of this project. I am equally grateful to
    ...
    Finally, I wish to thank my family and fellow students for their
    continued support during my Master's programme.
